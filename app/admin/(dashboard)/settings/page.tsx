  ...
  if (loading) {
    return (
      <div className="p-20 text-center">
        ...
        <p className="text-accent-gold/60">설정을 불러오는 중입니다...</p>
      </div>
    );
  }
  ...
  return (
    <main className="p-6 md:p-10 space-y-8 max-w-5xl">
      ...
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl md:text-4xl font-semibold flex items-center gap-3 text-white">
            <Settings className="text-accent-gold" /> 설정 관리
          </h1>
        ...
        <button 
          onClick={handleSave}
          disabled={saving}
          className="rounded-2xl bg-accent-gold text-purple-900 px-8 py-4 font-bold hover:bg-accent-gold-deep transition-all shadow-lg flex items-center gap-2 disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-20">
        ...
        {/* 1. 기본 정보 */}
        <section className="rounded-3xl border border-accent-gold/10 bg-white/5 backdrop-blur-xl p-8 space-y-6">
          <h2 className="text-xl font-semibold flex items-center gap-2 text-accent-gold-light">
            <Globe className="w-5 h-5 text-accent-gold" /> 기본 정보
          </h2>
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <input 
                type="text" 
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent-gold/50" 
        ...
        <section className="rounded-3xl border border-accent-gold/10 bg-white/5 backdrop-blur-xl p-8 space-y-6">
          <h2 className="text-xl font-semibold flex items-center gap-2 text-accent-gold-light">
            <CreditCard className="w-5 h-5 text-accent-gold" /> 결제/입금 정보
          </h2>
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <textarea 
                rows={3} 
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent-gold/50 resize-none" 
        ...
        {/* 3. 리포트 발송 기본 문구 */}
        <section className="rounded-3xl border border-accent-gold/10 bg-white/5 backdrop-blur-xl p-8 space-y-6 md:col-span-2">
          <h2 className="text-xl font-semibold flex items-center gap-2 text-accent-gold-light">
            <MessageSquare className="w-5 h-5 text-accent-gold" /> 리포트 발송 기본 문구
          </h2>
        ...
        <section className="rounded-3xl border border-accent-gold/10 bg-white/5 backdrop-blur-xl p-8 space-y-6 md:col-span-2">
          <h2 className="text-xl font-semibold flex items-center gap-2 text-accent-gold-light">
            <Layout className="w-5 h-5 text-accent-gold" /> 사이트 노출 설정
          </h2>
