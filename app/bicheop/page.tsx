...
export const metadata = {
  title: '비첩 | 백도화 매력학당',
  description: '백도화의 비첩은 사랑, 재회, 풍요, 매력, 마음의 흐름을 읽는 은밀한 기록입니다.',
}
            ...
            <section className="text-center mb-16">
              <Reveal delayMs={100}>
                ...
                <h1 className="text-4xl md:text-5xl font-elegant font-bold text-white mb-6 tracking-wide">
                  비첩 <span className="text-[#E6BE8A] font-normal font-serif text-3xl md:text-4xl">(秘帖)</span>
                </h1>
                <p className="text-sm md:text-base text-[#EDE6DA] opacity-75 max-w-xl mx-auto break-keep leading-relaxed font-light font-elegant italic">
                  “백도화의 비첩은 사랑, 재회, 풍요, 매력, 마음의 흐름을 읽는 은밀한 기록입니다.”
                </p>
              </Reveal>
            </section>
