          ...
          <div className="container mx-auto max-w-4xl">
            <div className="bg-[#1a0f2e]/60 backdrop-blur-md border border-[rgba(212,175,55,0.15)] p-8 md:p-16 rounded-2xl shadow-2xl">
              ...
              <div className="space-y-10 text-[#EDE6DA] leading-relaxed opacity-90">
                ...
                <section>
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제2조 수집하는 개인정보 항목</h2>
                  <p className="mb-4">회사는 서비스 제공을 위해 다음과 같은 개인정보를 수집할 수 있습니다.</p>
                  
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-bold text-[#D4AF37]/80 mb-2">[필수항목]</h3>
                    ...
                    <div>
                      <h3 className="font-bold text-[#D4AF37]/80 mb-2">[선택항목]</h3>
                      <ul className="list-disc list-inside pl-4 space-y-1 opacity-80">
                        <li>추가 상담 내용</li>
                        <li>관계 정보</li>
                ...
                <section>
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제3조 개인정보 수집 및 이용 목적</h2>
                ...
                <section>
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제4조 개인정보 보유 및 이용 기간</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제5조 개인정보 제3자 제공</h2>
                ...
                <section>
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제6조 개인정보 보호 책임자</h2>
                ...
                <section className="pt-10 border-t border-[rgba(212,175,55,0.1)]">
                  <h2 className="text-xl font-bold text-[#D4AF37] mb-4">제7조 정책 변경</h2>
