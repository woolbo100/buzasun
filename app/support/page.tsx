          ...
          <div className="container mx-auto max-w-3xl">
            <div className="gungjung-glass p-8 md:p-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Kakao Support */}
                <div className="p-8 rounded-2xl border border-[rgba(216,191,163,0.15)] bg-white/5 flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-[#EDE6DA] opacity-60 mb-8 leading-relaxed">
                    가장 빠른 응대가 필요하시다면<br />카카오톡 실시간 상담을 이용해보세요.
                  </p>
                  <a 
                    href="https://pf.kakao.com/_CxdfxgG" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-full py-4 rounded-xl bg-[var(--accent-gold)] text-[#120014] hover:brightness-110 transition-all font-bold"
                  >
                    상담 시작하기
                  </a>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-[rgba(216,191,163,0.15)] bg-white/5 flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-[#EDE6DA] opacity-60 mb-8 leading-relaxed">
                    상세한 분석 요청이나 제휴 문의는<br />이메일로 접수해주시면 확인 후 답변드립니다.
                  </p>
                  <a 
                    href="mailto:buzasun@naver.com" 
                    className="w-full py-4 rounded-xl border border-[var(--accent-gold)] text-[var(--accent-gold)] hover:bg-[var(--accent-gold-soft)] transition-all font-bold"
                  >
                    메일 보내기
                  </a>
                </div>
