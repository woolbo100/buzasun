      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        <Reveal delayMs={300}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            >
              ...
              <p className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-xs text-bd-gray opacity-60 whitespace-nowrap">
                당신만의 코드를 발견하세요
              </p>
            </Link>
        ...
        <Reveal delayMs={500}>
          <button
            ...
            className="group flex flex-col items-center gap-2 text-bd-gray hover:text-bd-ivory transition-all duration-300 opacity-70 hover:opacity-100"
            aria-label="아래로 스크롤"
          >
            <span className="text-sm font-medium tracking-wider" style={{ letterSpacing: '0.1em' }}>
              백도화의 세계로 들어가기
            </span>
            <div className="flex flex-col items-center gap-1">
              <i className="fas fa-chevron-down text-xs animate-bounce"></i>
              <div 
                className="h-8 w-px bg-gradient-to-b from-pink-200/50 to-transparent transition-all duration-300 group-hover:from-pink-200"
                style={{
