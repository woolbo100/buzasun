  ...
  return (
    <div className="space-y-3 w-full">
      ...
      <button
        ...
        disabled={!!loading}
        className="w-full bg-[#FEE500] hover:bg-[#FDE000] text-[#191919] font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg disabled:opacity-50"
      >
      ...
      <button
        ...
        disabled={!!loading}
        className="w-full bg-white hover:bg-gray-50 text-[#333333] font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg border border-gray-200 disabled:opacity-50"
      >
